 ...
 * <code>RecipeParser</code>. It's responsible for compiling the recipe and
 * checking all the directives exist before concluding that the directives are
 * ready for execution.
 */
public class GrammarBasedParser implements RecipeParser {
    ...
    /**
     * Custom Visitor to parse ByteSize and TimeDuration tokens.
     */
    private static class DirectiveVisitor extends DirectivesBaseVisitor<Token> {
        ...
        // Add more visit methods if needed (e.g., visitStringLiteral, visitIntLiteral etc.)
    }
}
